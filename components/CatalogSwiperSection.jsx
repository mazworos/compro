        ...
        <div className="py-8 lg:py-28">
            <div className="container grid pb-8 lg:grid-cols-1">
                <div className="text-left">
                    ...
                    className="py-4 text-4xl font-medium lg:text-6xl lg:py-0">Modern Clasic</motion.h1>
                ...
                className="grid grid-cols-2 text-gray-500 gap-x-8">
                    <p>
                        With our passion for design and decor, we have created a collection of furnitre and accesories that will help you create a comfortable and stylish home. 
                        With our passion for design and decor, we have created a collection of furnitre and accesories that will help you create a comfortable and stylish home. 
                    </p>
                    <p>
                        With our passion for design and decor, we have created a collection of furnitre and accesories that will help you create a comfortable and stylish home. 
