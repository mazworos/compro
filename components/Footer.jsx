      ...
      <div className="container lg:grid lg:grid-cols-2 py-14">
        ...
        >
          ...
          <p className="pt-4 text-gray-500">
            By Subscribing to our newsletter, you agree to receive emails from us. Your personal data will be stored and processed in accordance with our Privacy Policy
      ...
      className="py-10 bg-black dark:bg-primary">
        <div className="container text-white text-center lg:justify-between lg:flex">
          <div className="pb-4 lg:pb-0">
            <p>&copy;2024 Homellow. All Rights Reserved</p>
          </div>
          <div>
